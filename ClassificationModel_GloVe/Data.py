...
2. Sentence Classification or Multi-Class sentence Classification
    a. 1 Coder
    b. 2 Coders
        i. Similar labelled sentences by the two coders
        ii. Different labelled sentences  by the two coders
    c. 3 Coders
        i. Similar labelled sentences by the three coders

The data is then divided into Training and Test data and saved as dataframe.
"""
...
# Class to clean data and produce Training and Test Data
class CreateDataset(object):
    ...
    # To get equal no. of Usefull and Usefull sentences for Binary Classification
    ...
    # To get label, get first label in case of multiple labels
    @staticmethod
    ...
    # To get sentences which are labelled same by the coders
    @staticmethod
    def get_similar(row):
    ...
    # To get sentences which are labelled different by the coders
    @staticmethod
