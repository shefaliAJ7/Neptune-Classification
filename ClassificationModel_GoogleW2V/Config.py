...
# File needed to perform Word2Vec - Not needed here, as its not pre-trained, it will train the Word2Vec from the corpora of Dataset
...
PREDICTION_FILE = 'Sally_Trixy_DisAgree'